...
class STMDeviceTree:
    ...
    def addDmaToNode(p, driver):
        ...
        if mux_channels is not None:
            ...
            driver_channels.addSortKey(lambda e: (int(e.get("instance", 0)),
            ...
            for channel in mux_channels:
                ...
                chan.setAttribute("instance", 1)  # H7 has further mux instances for yet unsupported BDMA
                chan.setAttribute("position", channel["position"])
                chan.setAttribute("dma-instance", channel["dma-instance"])
                chan.setAttribute("dma-channel", channel["dma-channel"])
